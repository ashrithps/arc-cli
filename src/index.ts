...
async function normalizeSchedulePayload(client: ActualClient, payload: any): Promise<any> {
...
async function normalizeRuleFieldValue(client: ActualClient, field: string, value: any): Promise<any> {
...
async function normalizeRulePayload(client: ActualClient, payload: any): Promise<any> {
  const normalized = {
    ...payload,
